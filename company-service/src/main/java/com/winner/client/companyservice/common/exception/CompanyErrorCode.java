...
public enum CompanyErrorCode implements ErrorCode {
  ...
  NAME_REQUIRED("ERROR_106",HttpStatus.BAD_REQUEST,"업체 이름은 필수 입력값입니다."),

  DUPLICATE_COMPANY("ERROR_107", HttpStatus.CONFLICT, "이미 사용 중인 업체입니다."),

  INVALID_ADDRESS("ERROR_108", HttpStatus.BAD_REQUEST, "주소가 잘못되었습니다."),
  INVALID_LATITUDE("ERROR_109", HttpStatus.BAD_REQUEST, "잘못된 위도값입니다."),
  INVALID_LONGITUDE("ERROR_110", HttpStatus.BAD_REQUEST, "잘못된 경도값입니다."),
  ADDRESS_API_ERROR("ERROR_111", HttpStatus.INTERNAL_SERVER_ERROR, "주소 조회 서비스와 통신 중 오류가 발생했습니다."),
  ADDRESS_TRANSFORMATION_FAILED("ERROR_112", HttpStatus.BAD_REQUEST, "주소를 좌표로 변환하는 데 실패하였습니다.");
